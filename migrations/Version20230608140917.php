 ...
 */
final class Version20230608140917 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD supplier_id INT DEFAULT NULL, ADD sub_category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP supplier_id, DROP sub_category_id');
    }
}
